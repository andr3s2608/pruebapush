...
@Component({
  selector: 'app-ajuste-solicitud-servicio-programador',
  templateUrl: './ajuste-solicitud-servicio-programador.component.html',
  styleUrls: ['./ajuste-solicitud-servicio-programador.component.scss']
})
export class AjusteSolicitudServicioProgramadorComponent implements OnInit {
  show: boolean = false;
